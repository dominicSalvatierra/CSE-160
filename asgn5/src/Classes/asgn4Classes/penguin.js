class Penguin {
    ...
    renderUpperBody() {
        ...
        prismBlock.textureNum = this.textureNum;
        prismBlock.texWeight = this.texWeight;
        cubeBlock.textureNum = this.textureNum;
        cubeBlock.texWeight = this.texWeight;
      
        for (i = 0; i < 4; i++) {
          //color[i] = [1.0 - i * 0.05, 1.0 - i * 0.05, 1.0 - i * 0.05, 1.0 - i * 0.05];
          color[i] = [1.0,1.0,1.0,1.0];
        }
        for (; i < 10; i++) {
        ...
        prismBlock.normalMatrix.setInverseOf(prismBlock.matrix).transpose();
        prismBlock.render();
        ...
        cubeBlock.normalMatrix.setInverseOf(cubeBlock.matrix).transpose();
        cubeBlock.render();
    ...
    renderLowerBody() {
        ...
        prism.textureNum = this.textureNum;
        prism.texWeight = this.texWeight;
        cube.textureNum = this.textureNum;
        cube.texWeight = this.texWeight;
        ...
        prism.normalMatrix.setInverseOf(prism.matrix).transpose();
        prism.render();
